...
class TestTaggingMission(unittest.TestCase):
        ...
        def mock_torpedo_service(torpedo_num):
            if torpedo_num == 1:
                return types.SimpleNamespace(
                    success=True, message="Torpedo 1 fired - full hit through opening"
                )
            else:
                return types.SimpleNamespace(
                    success=True, message="Torpedo 2 fired - partial hit on board"
                )
    ...
    def test_board_configuration_detection(self):
        ...
        self.tm.detected_objects = {"reef_shark": mock_shark, "sawfish": mock_sawfish}
    ...
    def test_far_distance_detection(self):
        ...
        self.tm.detected_objects = {"board": mock_board, "horizontal_bar_1": mock_bar}
    ...
    def test_hit_result_parsing(self):
        ...
        self.assertEqual(
            self.tm.parse_hit_result("Torpedo hit board partially"), "partial"
        )
